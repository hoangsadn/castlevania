...
public:
	...
	void TypeMapToString()
	{
		...
		ADDSTATE(WALKING, "WALKING");
		ADDSTATE(WALKING_LEFT, "WALKING_LEFT");
		ADDSTATE(WALKING_RIGHT, "WALKING_RIGHT");
		ADDSTATE(JUMPING, "JUMPING");
		ADDSTATE(JUMPING_RIGHT, "JUMPING_RIGHT");
		ADDSTATE(JUMPING_LEFT, "JUMPING_LEFT");
		ADDSTATE(FALLING, "FALLING");
		ADDSTATE(FALLING_LEFT, "FALLING_LEFT");
		ADDSTATE(FALLING_RIGHT, "FALLING_RIGHT");
		ADDSTATE(STANDING, "STANDING");
		ADDSTATE(STANDING_LEFT, "STANDING_LEFT");
		ADDSTATE(STANDING_RIGHT, "STANDING_RIGHT");
		ADDSTATE(DOWNING, "DOWNING");
		ADDSTATE(DOWNING_LEFT, "DOWNING_LEFT");
		ADDSTATE(DOWNING_RIGHT, "DOWNING_RIGHT");
		ADDSTATE(RECIVE_RIGHT, "RECIVE_RIGHT");
		ADDSTATE(RECIVE_LEFT, "RECIVE_LEFT");
		ADDSTATE(HURTED, "HURTED");
		ADDSTATE(HITTING, "HITTING");
		ADDSTATE(HITTING_STAND_LEFT, "HITTING_STAND_LEFT");
		ADDSTATE(HITTING_STAND_RIGHT, "HITTING_STAND_RIGHT");
		ADDSTATE(HITTING_DOWN_LEFT, "HITTING_DOWN_LEFT");
		ADDSTATE(HITTING_DOWN_RIGHT, "HITTING_DOWN_RIGHT");
		ADDSTATE(THROWING, "THROWING");
